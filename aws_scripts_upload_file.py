# /Users/sahitya_gantala/Desktop/projects/aws_scripts.py
...
# uploading a and listing objects
s3.upload_file("s3_new_local_file.csv","my-first-bucket-2025-12345","uploaded.csv")
